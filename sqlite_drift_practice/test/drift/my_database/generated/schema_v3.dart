...
class GroupsData extends DataClass implements Insertable<GroupsData> {
  ...
  GroupsData copyWith({int? id, DateTime? createdAt, String? name}) =>
      GroupsData(
        id: id ?? this.id,
        createdAt: createdAt ?? this.createdAt,
        name: name ?? this.name,
...
class Common extends Table with TableInfo<Common, CommonData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  Common(this.attachedDatabase, [this._alias]);
  ...
  @override
  List<GeneratedColumn> get $columns => [artistId, albumId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  Common createAlias(String alias) {
    return Common(attachedDatabase, alias);
  }
}
...
class CommonData extends DataClass implements Insertable<CommonData> {
  final int artistId;
  final int albumId;
  const CommonData({required this.artistId, required this.albumId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  CommonCompanion toCompanion(bool nullToAbsent) {
    return CommonCompanion(artistId: Value(artistId), albumId: Value(albumId));
  }
  ...
  CommonData copyWith({int? artistId, int? albumId}) => CommonData(
  ...
  @override
  int get hashCode => Object.hash(artistId, albumId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is CommonData &&
...
class DatabaseAtV3 extends GeneratedDatabase {
  ...
  late final Common common = Common(this);
  @override
